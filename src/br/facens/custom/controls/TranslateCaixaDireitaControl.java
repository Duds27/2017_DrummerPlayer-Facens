 ...
 * @author Eduardo
 */
public class TranslateCaixaDireitaControl extends DrummerAbstract {
    ...
    protected void controlUpdate(float tpf) {
        if (Main.getApp().isMexerCaixaDireita()) {        
    ...
    public Control cloneForSpatial(Spatial spatial) {
        this.enabled = false;
        TranslateCaixaDireitaControl control = new TranslateCaixaDireitaControl();
