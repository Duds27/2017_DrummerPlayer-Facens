 ...
 * @author Eduardo
 */
public class TranslatePratoAbertoControl extends DrummerAbstract {
    ...
    protected void controlUpdate(float tpf) {
        if (Main.getApp().isMexerPratoAberto()) {        
    ...
    public Control cloneForSpatial(Spatial spatial) {
        this.enabled = false;
        TranslatePratoAbertoControl control = new TranslatePratoAbertoControl();
