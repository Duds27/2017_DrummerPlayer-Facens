 ...
 * @author Eduardo
 */
public class RotatePratoDireitoControl extends DrummerAbstract {
    private float speed = 1;
    private Node rootNode;
    private AssetManager assetManager;

    
    public RotatePratoDireitoControl(String name) {
        super(name);
    }
    
    public RotatePratoDireitoControl() {}    
    ...
    protected void controlUpdate(float tpf) {
        if (Main.getApp().isMexerPratoDireito()) {        
    ...
    public Control cloneForSpatial(Spatial spatial) {
        this.enabled = false;
        RotatePratoDireitoControl control = new RotatePratoDireitoControl();        
