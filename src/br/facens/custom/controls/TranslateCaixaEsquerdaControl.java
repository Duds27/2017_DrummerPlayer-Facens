 ...
 * @author Eduardo
 */
public class TranslateCaixaEsquerdaControl extends DrummerAbstract {
    ...
    protected void controlUpdate(float tpf) {
        if (Main.getApp().isMexerCaixaEsquerda()) {        
    ...
    public Control cloneForSpatial(Spatial spatial) {
        this.enabled = false;
        TranslateCaixaEsquerdaControl control = new TranslateCaixaEsquerdaControl();        
