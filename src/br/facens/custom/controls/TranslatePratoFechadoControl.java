 ...
 * @author Eduardo
 */
public class TranslatePratoFechadoControl extends DrummerAbstract {
    ...
    protected void controlUpdate(float tpf) {
        if (Main.getApp().isMexerPratoFechado()) {        
    ...
    public Control cloneForSpatial(Spatial spatial) {
        this.enabled = false;
        TranslatePratoFechadoControl control = new TranslatePratoFechadoControl();
