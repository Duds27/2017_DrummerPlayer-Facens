 ...
 * @author Eduardo
 */
public class TranslateCaixaCentralControl extends DrummerAbstract {
    ...
    protected void controlUpdate(float tpf) {
        if (Main.getApp().isMexerCaixaCentral()) {        
    ...
    public Control cloneForSpatial(Spatial spatial) {
        this.enabled = false;
        TranslateCaixaCentralControl control = new TranslateCaixaCentralControl();
